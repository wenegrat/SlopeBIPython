...
#        solver.solve_sparse(solver.pencils[0], nz, 0+1j*1, rebuild_coeffs=True)
        # sort eigenvalues
...
#        print(str(solver.eigenvalues))
        return (solver.eigenvalues[idx[-1]].imag, idx)

    # get max growth rates
    (grt, idx) = max_growth_rate(k, l)
